  ...
  <div class="container">
    <nav class="navbar navbar-dark bg-primary">
      <div class="container-fluid">
        <a class="navbar-brand">CinemaLabTi21</a>
        <form class="d-flex">
    ...
    <figure class="text-center mt-5">
      ...
      <figcaption class="blockquote-footer"><cite title="Source Title">CRUD : Create, Read, Update dan Delete</cite>
      </figcaption>
    </figure>
      ...
      <tbody>
        ...
        while ($data = mysqli_fetch_array($sql)) {
          ...
          <tr>
            ...
            <td><a href="olah.php" id=<?php echo $data['id']; ?>><svg xmlns="http://www.w3.org/2000/svg" width="16"
              ...
              <a href="proses.php?hapus=<?php echo $data['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16"
